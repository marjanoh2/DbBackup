...
Решението е составено од три проекти:
   1. DbCommon - тука се класите и методите кои се користат за извршување на сите задачи поврзани со правење бекап
   2. DbController - десктоп апликација за внесување параметри и следење статус на направените бекапи и евентоални грешки
   3. DbService - windows сервис кој работи постојано во позадина
